...
const Footer = () => {
    return (
        <footer className="  bg-[#1b6392]">
            <div className="py-[30px] mx-auto w-full max-w-[500px] flex flex-col gap-[10px]">
                ...
                <div className="max-w-[450px] bg-white p-2 flex mx-auto gap-[5px] md:[10px]">
                    <input
                    ...
                    <button className=" px-2 text-white bg-[#fa8232] flex items-center gap-[5px] capitalize">
                        <p className="font-[600] uppercase">subscribe</p>
                        <div className="w-4 h-4">
                            <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" fill="white">
